...
class Block(nn.Module):
    def __init__(self, in_ch, out_ch):
        ...
        # Initialize weights using your preferred method (e.g., Xavier initialization)
...
class UNet(nn.Module):
    def __init__(self, enc_chs=(3,64,128,256,512,1024), dec_chs=(1024, 512, 256, 128, 64), num_class=8, retain_dim=False, out_sz=(572,572)):
        super().__init__()
